...
function agregarEjercicio() {
    ...
    nuevoEjercicio.innerHTML = `
        <label for="opciones">Ejercicio:</label> 
            <select name="opciones[]">
            ${document.querySelector('select[name="opciones[]"]').innerHTML}
            </select><br>
        <label for="series">Series:</label> <input type="number" name="series[]" placeholder="Introduce nº de series"><br>
        <label for="repeticiones">Repeticiones:</label> <input type="number" name="repeticiones[]" placeholder="Introduce nº de repeticiones"><br>
        <label for="peso">Peso(kg.):</label> <input type="number" name="peso[]" placeholder="Introduce peso en kg"><br>
    `;
