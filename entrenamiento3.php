...
<div id="mensaje" style="display: none; padding:20px; margin:10px; border-radius:10px; border:1px solid green; background-color:#9EF7A1;"><p>Entrenamiento creado con éxito.</p></div>
    <h3>Entrenamiento Espalda y hombros:</h3><br>
    <strong>Dia<span style="color: red;">*</span>:</strong> <input type="date" id="dia" required><br>
    <div class="ejercicio">
        <label for="opciones">Ejercicio 1:</label> <input type="text" name="opciones" value="Dominadas" readonly><br>
    ...
    <div class="ejercicio">
        <label for="opciones">Ejercicio 2:</label> <input type="text" name="opciones" value="Peso muerto" readonly><br>
        <label for="series">Series:</label> <input type="number" name="series" value="4" readonly><br>
        <label for="repeticiones">Repeticiones:</label> <input type="number" name="repeticiones" value="10" readonly><br>
        <label for="peso">Peso<span style="color: red;">*</span>:</label> <input type="number" name="peso" placeholder="Introduce peso en kg" required><br>
    </div>
    <div class="ejercicio">
        <label for="opciones">Ejercicio 3:</label> <input type="text" name="opciones" value="Remo" readonly><br>
        <label for="series">Series:</label> <input type="number" name="series" value="4" readonly><br>
        <label for="repeticiones">Repeticiones:</label> <input type="number" name="repeticiones" value="10" readonly><br>
        <label for="peso">Peso(kg.)<span style="color: red;">*</span>:</label> <input type="number" name="peso" placeholder="Introduce peso en kg" required><br>
    </div>
    <div class="ejercicio">
        <label for="opciones">Ejercicio 4:</label> <input type="text" name="opciones" value="Press Militar" readonly><br>
        <label for="series">Series:</label> <input type="number" name="series" value="4" readonly><br>
        <label for="repeticiones">Repeticiones:</label> <input type="number" name="repeticiones" value="10" readonly><br>
        <label for="peso">Peso(kg.)<span style="color: red;">*</span>:</label> <input type="number" name="peso" placeholder="Introduce peso en kg" required><br>
    </div>
    <div class="ejercicio">
        <label for="opciones">Ejercicio 5:</label> <input type="text" name="opciones" value="Elevacion lateral con mancuernas" readonly><br>
